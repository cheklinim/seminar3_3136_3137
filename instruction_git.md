...
-----------------------------------------------------------------
Начало работы Елистратов Дмитрий
-----------------------------------------------------------------

## Удаленные репозитории
Удаленный (внешний) репозиторий – это версии вашего проекта, сохраненные на удаленном сервере.
## Создание нового репозитория на GitHub
зарегистрироваться на сайте github.com, создать репозиторий
## Связывание локального и удаленного репозиториев
    git remote add origin https://github.com/ElistratovDmitry/test.git

## Извлечения и загрузки содержимого из удаленного репозитория
    git pull [адрес], можно без адреса, если было связывание
...
## Создание ответвления чужого проекта на GitHuB
...
**После Fork сделать pull в локальный Git, создать новую ветку и работать в ней**

## Запрос слияния своего ответвления чужого проекта с основным проектом
сделать push  свой репозитарий на GitHub
нажать на pull request
