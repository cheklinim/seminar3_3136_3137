...
После создания удаленного репозитория GitHub перекидывает на страничку с подсказками для создания свзки удаленного и локального репозитория. В терминале VSC нужно последовательно ввести команды:
...
Для получения данных из удаленного репозитория используется команда:
