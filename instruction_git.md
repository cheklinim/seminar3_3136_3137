...
Удаленные репозитории нужны для того, чтобы иметь возможность совместной работы над каким-либо Git-проектом.
...
Она позволяет передать коммиты из локального репозитория в удаленный.
 ...
 Для извлечения и загрузки содержимого из удаленного репозитория и немедленного обновления локального репозитория этим содержимым иоспользуется команда:

    git pull

## Копия репозитория

Для создания точной копии оригинального репозитория, только на сервисе GitHub используется команда:

    git fork

Для предложения изменения кода в чужом репозитории используется команда:
