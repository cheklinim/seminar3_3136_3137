...
После регистрации нажимаем кнопочку "+" и вводим название репозитория. Выбираем тип Public или Private и нажимаем Create repository.
...
В какую ветку
    ...
    git branch -M main
main - ветка куда будут загружаться изменения
