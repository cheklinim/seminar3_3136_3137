...
С помощью него создается точная копия оригинального репозитория, только на сервисе GitHub. В копии репозитория можно вносить свои собственные изменения, редактировать файлы или удалять директории. Для этого нужно использовать команду:

    git clone https://github.com/YuliaFilatova/seminar3_3136_3137.git

вместо https://github.com/YuliaFilatova/seminar3_3136_3137.git нужно использовать собственный URL-адрес репозитория который нужно клонировать.

Как только все изменения будут внесены, то можно поделиться ими - отправить авторам оригинального репозитория запрос на слияние вашего измененного репозитория с их оригинальным репозиторием. Используя команду:
