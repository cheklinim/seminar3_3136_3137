...
Для того чтобы предлагать свои изменения в чужие репозитории необходимо:
* скопировать чужой репозиторий к себе на аккаунт посредством кнопки форк (вилка)
* создать новую ветку и работать в ней


    git clone ссылка_на_ваш_проект_или_копию_чужого_проекта_на_вашем_аккаунте

Репозиторий сохранится в новой папке, для того чтобы в нее проволиться используй команду:

    cd имя_папки

## Кнопки Compare&Pull request либо Contribute-Open pull request

Эти кнопки позволяют предложить свои изменения автору кода.

    Compare&Pull request - появляется при выборе ветки, где вносились изменения.
*Если не появляется - используешь 2 способ.*

В заголовке обычно указывают суть предложения, в комментарии можно подробно описать изменения. 
