...
5. Для выгрузки изменений файла с удаленного репозитория в локальный (необходимо для работы с наиболее актуальным файлом или при командной работе и т.д., при этом **настоятельно рекомендуется** перед работой сделать pull, а затем уже push), используйте команду:

        git pull

6. Для работы с чужим репозиторием (при наличии ссылки) необходимо **в vscode создать новую пустую папку** используйте команду:

        git clone <ссылка на чужой удаленный репозитарий>

Обратите внимаение, что, для того чтобы дальше работать с данным файлом необходимо использовать команду: _**cd <название новой пустой папки>**_. Только после этого будет возможным работать с данным репозитарием, но только локально! Запушить данный файл к владельцу исходника будет не возможно, по причине отсутсвия права вносить изменения на Github.

7. Для работы в open sourse проектах (командная работа над файлом) необходимо выполнить Fork удаленного репозитария к себе на компьютер, указать желаемую для этого папку, затем указать необходимую ветку в копируемом репозитарии. При выполнении данных действий, чужой репозиторий копируется в в наш репозиторий, из которого мы , применяя команду **_git clone <ссылка на удаленный репозитарий>_**

![Расположение Fork](image3.jpg)

#Важно!!! 

         при выполнении действий в пп.7 все свои работы необходимо производить в своей, новой, ветке, не в Master или не той которую мы клонировали!!! Т.е. выполнить git branch <> и git checkout