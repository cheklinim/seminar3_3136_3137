...
### Подтягивание коммитов из удаленного репозитория в локальный

Для того чтобы подтянуть разницу коммитов между УР и ЛР, нужно ввсети:

    git pull

### Отправления коммитов в удаленную репозиторию

Чтобы отправить ранее созданный коммит в удаленную репозиторию, нужно ввести команду:
