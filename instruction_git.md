...
![Image](https://git-scm.com/book/en/v2/images/forkbutton.png)
...
Для начала, нажмите кнопку «Fork», как было сказано выше, чтобы заполучить собственную копию проекта. Мы зарегистрированы на GitHub под именем «user», так что наша копия окажется по адресу https://github.com/user/project, где мы сможем редактировать её. Мы клонируем его, создадим тематическую ветку, внесём необходимые изменения и, наконец, отправим их на GitHub.
