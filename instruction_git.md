...
Для работы с чужим удалённым репозиторием его необходимо скопировать со страницы этого репозитория на github к себе в аккаунт с помощью кнопки 

    Fork

Затем в терминале необходимо скопировать репозиторий с помощью команды

    git clone <Ссылка на копию репозитория в своем аккаунте>

После внесения необходимых изменений и выгрузки их в свой глобальный репозиторий, можно отправить эти изменения в оригинальный репозиторий. Для этого на странице своего глобального репозитория выберите
...
При работе с чужим проектом не рекомендруется делать изменения в главной ветке **master**, рекомендуется создавать дополнительные ветки.
