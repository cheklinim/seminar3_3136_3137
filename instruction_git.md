...
Все данные, доступные в локальном репозитории, могут быть загружены в удаленный репозиторий на GitHub. Используется команда
...
Позволяет сделать копию чужого репозитория, нужно иметь свою собственную учетную запись на GitHub и нужно войти под ней на GitHub в момент выполнения. С помощью него создается точная копия оригинального репозитория, только на сервисе GitHub. В копии репозитория можно вносить свои собственные изменения. 

### pull request

Как только все изменения в вашей копии будут внесены, то можно поделиться ими - отправить авторам оригинального репозитория запрос на слияние вашего измененного репозитория с их оригинальным репозиторием. Такой запрос называется
