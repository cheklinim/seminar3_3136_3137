...
На своем устройстве нужно ввести в терминале все выше перечиленные команды. ***Различие в командах будет следующим: ссылка в соответвии с данным пользователем и имя ветки, которое должно совпадать с названием главной ветки репозитория.
