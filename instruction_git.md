...
## Делаем pull requests и как это работет

Перед тем как начать работь в своей копии чужого репозитория нужно создать новую ветку и дальше уже спокойно создавать новое и коммитить  

Когда наш проект достигает момента, что мы хотим поделиться наработками - необходимо запушить изменения командой git push

По дефолту push мб настроен на отправку в другую ветку, поэтому git предложит актуальную команду для того чтобы push прошел в нужную ветку

после успешного пуша , в своем акканунте githab можно увидеть изменения в этой копии чужого репозитория и можно сделать pull request где будет заголовок с предложением и комментарием к проделанной работе. Отправляем и ждем обратную связь.
