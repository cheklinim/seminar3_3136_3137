...
возможно только при добавлении к себе через функцию **Fork**.

Если мы собираемся предлагать свои изменения другому пользователю, после клонирования репозитория, для начала создадим новую ветку, для работы над внесением изменений в проект.

Затем после всех изменений сохраним проект на Github. 

Теперь выбрав на сайте Github клонированый репозиторий у себя в профиле мы можем предложить свои изменения автору этого репозитория нажав на кнопку **Open pull request** 
